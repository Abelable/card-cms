...
import { useExportDelivers } from "service/produce";
import { useExportModal } from "../util";
import type { DeliversSearchParams } from "types/produce";
...
export const ExportModal = ({
  ...
  const generate = async () => {
    ...
    try {
      ...
      navigate("/produce/deliver/report_forms");
      setIsLoading(false);
    } catch (error) {
  ...
  const check = () => navigate("/produce/deliver/report_forms");
