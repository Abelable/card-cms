...
import { useDeliver } from "service/produce";

export const useProduceDeliversSearchParams = () => {
...
export const useProduceDeliversQueryKey = () => {
  const [params] = useProduceDeliversSearchParams();
  return ["produce_delivers", params];
};
